    ...
    <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 ">
        <div class="bg-black sm:w-1/2 xl:w-1/2 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden  text-white bg-no-repeat bg-cover relative">
            <div class="w-full lg:max-w-2xl md:max-w-md z-10 items-center text-center ">
                ...
                <div class="py-2 w-32 lg:w-40 mx-auto lg:py-3  rounded-bl-3xl rounded-tr-3xl bg-black ring ring-gray-900 hover:ring-orange-600  font-bold leading-tight mb-6  content-center items-center ">
                    ...
                    <div class=" flex items-center justify-center ">
                        <div class="lg:text-left text-center">
                            <div class=" flex flex-col  gap-6 items-center justify-center ">
                                <div class="md:hidden py-2 w-32 lg:w-40 mx-auto lg:py-3  rounded-bl-3xl rounded-tr-3xl bg-black ring ring-gray-900 hover:ring-orange-600  font-bold leading-tight mb-6  content-center items-center ">
                                    <h1 class="text-2xl lg:text-3xl rounded-bl-3xl rounded-tr-3xl text-orange-600">Tellme</h1>
                                </div>
